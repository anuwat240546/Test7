...
if st.button("ENTER", type="primary"):
    ...
    fig.add_trace(go.Scatter(x=dist_levels, y=settled_ground*100, name="Vertical Displacement", fill='tozeroy'))
    ...
    fig.add_trace(go.Scatter(x=hor_disp*100, y=height_levels, mode='lines+markers',name='Horizontal Displacement',line=dict(color='royalblue', width=4)))
