...
if st.button("ENTER", type="primary"):
    ...
    fig.add_trace(go.Scatter(x=[-5, user2 + 1, user2, -5],y=[0, 0, -2, -2],fill='toself',fillcolor='rgba(200, 200, 200, 0.3)',line=dict(width=0),name="Foundation Soil"))
    ...
    fig.update_layout(title="MSE Wall Deformation Cross-section",xaxis_title="Horizontal Distance / Displacement (m)",yaxis_title="Elevation (m)",width=600, height=900,
